...
TableLayout layout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Cursor cursor = adapter.selectCriminal();
            int l=0;
            while (cursor.moveToNext()) {
                ...
                row2.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Cursor cc = adapter.getAllCriminaldetails(compid);
                        while (cc.moveToNext()) {
                            Intent intent = new Intent(getApplicationContext(), Viewcriminaldetials.class);
