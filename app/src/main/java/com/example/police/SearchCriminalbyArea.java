...
public class SearchCriminalbyArea extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_criminalby_area);
        listView = findViewById(R.id.listviewwwwii);
            ...
            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                    ...
                    final ProgressDialog dialog =
                            new ProgressDialog(SearchCriminalbyArea.this);
                    ...
                    final Runnable progressRunnable = new Runnable() {
                        ...
                        public void run() {
                            ...
                            area = listView.getItemAtPosition(i).toString();

                            Toast.makeText(getApplicationContext(), "Criminal Found...." + area, Toast.LENGTH_SHORT).show();
                            AlertDialog.Builder alertbuilder = new AlertDialog.Builder(context);
                            TableLayout layout = new TableLayout(context);
                            layout.setGravity(Gravity.CENTER);


                            Cursor c = testAdapter.getcrimedtatarea(area);
                            while (c.moveToNext()) {
    ...
    private void addcriminalname() {
        ...
        while(c.moveToNext())
        {
            ...
            mylist.add(c.getString(9).toString());
