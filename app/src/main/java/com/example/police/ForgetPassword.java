...
public class ForgetPassword extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mid=(EditText) findViewById(R.id.urrno);
            ...
            b1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (TextUtils.isEmpty(id)) {
                        Toast.makeText(getApplicationContext(), "Please Enter Your Registered Mobile Number..", Toast.LENGTH_SHORT).show();
                        return;
                    }
                    ...
                    if (!srepass.matches(spass)) {
                        ...
                        if (i == 1) {
                            ...
                            Toast.makeText(getApplicationContext(), "Invalid Mobile OR Invalid Questions Answer..", Toast.LENGTH_SHORT).show();
                        }
