...
public class TestAdapter {
    ...
    private com.example.police.DatahelperActivity mDbHelper;

    public TestAdapter(Context context) {
        this.mContext = context;
        mDbHelper = new com.example.police.DatahelperActivity(mContext);
   ...
   /* public long InsertUpadteComplaint(String svno, String textactive, String textcomplete) {
    ...
    public long InsertCriminal(String pcaseid, String pcasetype, String pddate, String pcrname,
                               String cadd,String cpname,String gender, String page, String pmobile, String ppstationno,
                               String pfno, String paname, String pfyear, String psection,String cdesc) {
        ...
        values.put("C_Add", cadd);
        values.put("C_Parent", cpname);
        ...
        values.put("C_Desc", cdesc);

        i = mDb.insert("Criminal", null, values);
        return i;
    }

    public Cursor getAllCriminalbyyname(String str) {
        String q = "Select * from Criminal where C_Name='" + str + "'";
        Cursor c = mDb.rawQuery(q, null);
        return c;
    }
    ...
    public int checkcity(String city) {
        int i;
        String sql = "select C_Police ,count(*) from Criminal Group by Criminal";
        Cursor c = mDb.rawQuery(sql, null);
        //Log.w("Cursor", c.getString(0));
        c.moveToNext();
    ...
    public Cursor getcrimedtatarea(String area) {
        String q = "Select * from Criminal where C_Police='" + area + "'";
        Cursor c = mDb.rawQuery(q, null);
        return c;
    }


    public Cursor getcrimedtat(String name) {
        String q = "Select * from Criminal where C_Name='" + name + "'";
        Cursor c = mDb.rawQuery(q, null);
        return c;
    }
    ...
    public long Insertuser(String sno, String sname, String sadd,
                           String smobile, String sgen, String sadhar,String quest,String answer, String spass) {
        long i;
        ContentValues values = new ContentValues();
        values.put("U_No",sno);
    ...
    public long Updateuser(String id, String spass) {
        long i;
        ContentValues values = new ContentValues();
        values.put("Mobile", id);
        values.put("Password", spass);
        i=mDb.update("Register", values, "Mobile"+"="+id, null);
        return i;
    }

    public int checkUserIDandQuestions(String id, String question, String sans) {
        int i;
        String sql = "select count(*) from Register where Mobile='" + id + "' and Question='"+question+"' " +
                " and Answer='" + sans + "'";
        Cursor c = mDb.rawQuery(sql, null);
        //Log.w("Cursor", c.getString(0));
        c.moveToNext();
    ...
    public Cursor checkpridiction() {
        String sql = "select count(*) from Criminal where C_Police like 'ha%'";
        Cursor c = mDb.rawQuery(sql, null);
        return c;
    }

    public int checkpridictionn(String city) {
        int i;
        String sql = "select count(*) from Criminal where C_Police='"+city +"' like 'ha%'";
        Cursor c = mDb.rawQuery(sql, null);
        c.moveToNext();
        i = Integer.parseInt(c.getString(0));
        c.close();
    ...
    public int checkpridictionnswrget(String city) {
        int i;
        String sql = "select count(*) from Criminal where C_Police='"+city +"' like 'sw%'";
        Cursor c = mDb.rawQuery(sql, null);
        c.moveToNext();
        i = Integer.parseInt(c.getString(0));
        c.close();
    ...
    public int checkpridictionnshivajinager(String city) {
        int i;
        String sql = "select count(*) from Criminal where C_Police='"+city +"' like 'shi%'";
        Cursor c = mDb.rawQuery(sql, null);
        c.moveToNext();
        i = Integer.parseInt(c.getString(0));
        c.close();
    ...
    public int checkpridictionnkatraj(String city) {
        int i;
        String sql = "select count(*) from Criminal where C_Police='"+city+"' like 'Kat%'";
        Cursor c = mDb.rawQuery(sql, null);
        c.moveToNext();
        i = Integer.parseInt(c.getString(0));
        c.close();
    ...
    public int checkpridictmalvadi(String city) {
        int i;
        String sql = "select count(*) from Criminal where C_Police='"+city +"' like 'mal%'";
        Cursor c = mDb.rawQuery(sql, null);
        c.moveToNext();
        i = Integer.parseInt(c.getString(0));
        c.close();
    ...
    public int checkpridictmaloni(String city) {

        int i;
        String sql = "select count(*) from Criminal where C_Police='"+city +"' like 'lon%'";
        Cursor c = mDb.rawQuery(sql, null);
        c.moveToNext();
        i = Integer.parseInt(c.getString(0));
        c.close();
